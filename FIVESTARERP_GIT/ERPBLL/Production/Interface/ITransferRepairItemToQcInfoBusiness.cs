...
namespace ERPBLL.Production.Interface
{
    public interface ITransferRepairItemToQcInfoBusiness
    {
        ...
        Task<TransferRepairItemToQcInfo> GetTransferRepairItemToQcInfoByIdAsync(long repairLineId, long qcLineId, long modelId, long itemId,string status , long orgId);
        ...
        IEnumerable<TransferRepairItemToQcInfoDTO> GetTransferRepairItemToQcInfosByQuery(long? floorId, long? repairLineId, long? qcLineId, long? modelId, long? warehouseId, long? itemTypeId, long? itemId, string status, string transferCode, string fromDate, string toDate, long orgId);
